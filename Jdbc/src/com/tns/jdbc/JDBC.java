...
Class.forName("com.mysql.cj.jdbc.Driver");   //class loader 
		...
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/jyothi","root", "Jyothi@12345");     //create connection
			...
			String query1 = "insert into emp1 values(5,'jyothi')";  //Inserting new data in table by using  query1
